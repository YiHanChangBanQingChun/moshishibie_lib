function [labeled, unlabeled]= getlabeled(groundtruth, k)
%
...
%      precent: the precent of the labeled training samples you want to select
%
% Output:
...
for i=1:max(0,ceil(size(x1,1))-k)
    Tx=[Tx,x1(xx1(i))];
    Ty=[Ty,y1(xx1(i))];
end
...
for i=1:max(0,ceil(size(x2,1))-k)
    Tx=[Tx,x2(xx2(i))];
    Ty=[Ty,y2(xx2(i))];
end

xx3=randperm(size(x3,1));
%for i=1:min(10,ceil(size(x7,1)*precent))
for i=1:max(0,ceil(size(x3,1))-k)
    Tx=[Tx,x3(xx3(i))];
    Ty=[Ty,y3(xx3(i))];
end
...
for i=1:max(0,ceil(size(x4,1))-k)
    Tx=[Tx,x4(xx4(i))];
    Ty=[Ty,y4(xx4(i))];
end
...
for i=1:max(0,ceil(size(x5,1))-k)
    Tx=[Tx,x5(xx5(i))];
    Ty=[Ty,y5(xx5(i))];
end
...
for i=1:max(0,ceil(size(x6,1))-k)
    Tx=[Tx,x6(xx6(i))];
    Ty=[Ty,y6(xx6(i))];
end
...
for i=1:max(0,ceil(size(x7,1))-k)
    Tx=[Tx,x7(xx7(i))];
    Ty=[Ty,y7(xx7(i))];
end
...
%for i=1:ceil(size(x7,1)*precent)
for i=1:max(0,ceil(size(x8,1))-k)
    Tx=[Tx,x8(xx8(i))];
    Ty=[Ty,y8(xx8(i))];
end
...
%for i=1:ceil(size(x7,1)*precent)
for i=1:max(0,ceil(size(x9,1))-k)
    Tx=[Tx,x9(xx9(i))];
    Ty=[Ty,y9(xx9(i))];
end
...
%for i=1:ceil(size(x7,1)*precent)
for i=1:max(0,ceil(size(x10,1))-k)
    Tx=[Tx,x10(xx10(i))];
    Ty=[Ty,y10(xx10(i))];
end
...
%for i=1:ceil(size(x7,1)*precent)
for i=1:max(0,ceil(size(x11,1))-k)
    Tx=[Tx,x11(xx11(i))];
    Ty=[Ty,y11(xx11(i))];
end
...
%for i=1:ceil(size(x7,1)*precent)
for i=1:max(0,ceil(size(x12,1))-k)
    Tx=[Tx,x12(xx12(i))];
    Ty=[Ty,y12(xx12(i))];
end
...
%for i=1:ceil(size(x7,1)*precent)
for i=1:max(0,ceil(size(x13,1))-k)
    Tx=[Tx,x13(xx13(i))];
    Ty=[Ty,y13(xx13(i))];
end
...
%for i=1:ceil(size(x7,1)*precent)
for i=1:max(0,ceil(size(x14,1))-k)
    Tx=[Tx,x14(xx14(i))];
    Ty=[Ty,y14(xx14(i))];
end
...
%for i=1:ceil(size(x7,1)*precent)
for i=1:max(0,ceil(size(x15,1))-k)
    Tx=[Tx,x15(xx15(i))];
    Ty=[Ty,y15(xx15(i))];
end
...
%for i=1:ceil(size(x7,1)*precent)
for i=1:max(0,ceil(size(x16,1))-k)
    Tx=[Tx,x16(xx16(i))];
    Ty=[Ty,y16(xx16(i))];
end
T=[];
